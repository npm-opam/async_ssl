(* OASIS_START *)
(* DO NOT EDIT (digest: 45e4a2857da8cf7c1dd1b8ee1a846c0b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_ssl";
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("config/figure_out_openssl_flags.sh", [])))
                 ]
            };
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "async_ssl_bindings";
                           FindlibPackage ("bin_prot", None);
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some ".\218-P\001\153.\005*K\172Z\2334e4";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
